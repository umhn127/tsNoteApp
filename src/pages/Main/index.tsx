...
const Main = ({ availableTags, notes }: Props) => {
  ...
  */
  ...
  //   Every
  // - Dizideki bütün elemanlar koşulu sağlıyor mu diye kontrol eder.Hepsi koşulu sağlıyorsa true döndürür,aksi tadirde false döndürür.

  // Some
  // - Dizideki en az bir eleman koşulu sağlıyor mu diye kontrol eder.
  // - 1 tanesi bile koşulu sağlıyorsa true; hiçbiri sağlamıyorsa false döndürür
  ...
  return (
    <div className="container py-5">
      ...
      {/* NOT LİSTESİ */}
      <Row sm={1} lg={2} xl={3} className="g-3 mt-4">
